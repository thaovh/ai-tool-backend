...
export class InitialSchema1710500000000 implements MigrationInterface {
  name = 'InitialSchema1710500000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            CREATE TABLE "tbl_fine_tune_data" (
                ...
                CONSTRAINT "FK_fine_tune_data_created_by" FOREIGN KEY ("created_by") 
                    REFERENCES "tbl_user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION,
                CONSTRAINT "FK_fine_tune_data_updated_by" FOREIGN KEY ("updated_by") 
                    REFERENCES "tbl_user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
            )
        `);
    ...
    await queryRunner.query(`CREATE INDEX "IDX_user_phone" ON "tbl_user" ("phone_number")`);
    await queryRunner.query(
